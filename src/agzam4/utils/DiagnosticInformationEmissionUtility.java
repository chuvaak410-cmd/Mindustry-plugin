...
public class DiagnosticInformationEmissionUtility {
	...
	public static void main(String[] args) throws IOException {
		...
		for (int i = 0; i < type.length; i++) {
			...
			ApplicationDiagnosticMessageGateway.info("Events src: [blue]@[]", eventsFileSrc[i].absolutePath());
			ApplicationDiagnosticMessageGateway.info("Events trget: [blue]@[]", eventsFileDst[i].absolutePath());
		}
		
		if(!user.exists()) ApplicationDiagnosticMessageGateway.info("Events project not found");

		ApplicationDiagnosticMessageGateway.info("User dir: [blue]@[]", user.absolutePath());
